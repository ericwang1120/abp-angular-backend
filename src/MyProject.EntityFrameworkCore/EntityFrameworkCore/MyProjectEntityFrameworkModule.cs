...
namespace MyProject.EntityFrameworkCore
{
    ...
    public class MyProjectEntityFrameworkModule : AbpModule
    {
        ...
        public override void PreInitialize()
        {
            ...
            {
                Configuration.Modules.AbpEfCore().AddDbContext<MyProjectDbContext>(configuration =>
                {
                    MyProjectDbContextConfigurer.Configure(configuration.DbContextOptions, configuration.ConnectionString);
                });
            }
        }
